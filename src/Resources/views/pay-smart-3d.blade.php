        ...
        <div class="max-w-[500px] rounded-xl shadow-xl p-6 sm:p-8 shadow-[0_5px_20px_rgba(0,0,0,0.15)]">
            <div class="flex items-center justify-between mb-8">
                <div class="group flex items-center gap-2 text-sm font-medium text-zinc-500 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4 transition-transform group-hover:-translate-x-1">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
                    </svg>

                    <a href="{{ route('halkode.cancel') }}" class="font-medium hover:underline">
                ...
                <div class="grid grid-cols-12 gap-4 mb-5">
                    ...
                    <div>
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.error control-name="installments_number" />
                        </x-shop::form.control-group>
                    </div>
                </div>
